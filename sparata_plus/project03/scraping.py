...
client = MongoClient('15.165.159.162', 27017, username="test", password="test")
...
for place in places:
    ...
    headers = {
        "X-NCP-APIGW-API-KEY-ID": "r0i0oggk9v",
        "X-NCP-APIGW-API-KEY": "VdSjEjB2A3mCQNjsOSsP7VTEe6QIln0Yyd2xlVe0"
    }
